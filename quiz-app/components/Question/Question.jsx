...
export default function Question({ question, onChange }) {
  return (
    <section className="flex relative justify-items-center w-screen h-[5rem] bg-[#180520] text-[#E1A774]  border-b-[#E1A774] box-border border-[0.5rem] text-[0.8rem] scale-100">
      
        {/* <div className="flex self-start object-scale-down"> */}
          <label className="flex  place-self-center text-[0.8em] w-[30%]" htmlFor={question}>
            {question} {"\n"}
          </label>
        {/* </div> */}
